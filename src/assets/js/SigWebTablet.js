...
function makeUri() {
	...
	let mainUrl = 'tablet.sigwebtablet.com';
	mainUrl = '127.0.0.1';

	if (isIE()) {
		if (prot == 'https:') {
			return (prot + "//"+mainUrl+":47290/SigWeb/");
		}
		else {
			return (prot + "//"+mainUrl+":47289/SigWeb/");
		}
	}
...
function LcdWriteImage(Dst, Mode, Xp, Yp, Url) {
	...
	window.GetDaysUntilCertificateExpires = function () {
	...
	window.SetSigCompressionMode = function (v) {
	...
	window.SetDisplayXSize = function (v) {
	...
	window.SetDisplayYSize = function (v) {
	...
	window.SetImageXSize = function (v) {
		var Prop = "ImageXSize/";
	...
	window.SetImageYSize = function (v) {
		var Prop = "ImageYSize/";
	...
	window.SetImagePenWidth = function (v) {
	...
	window.SetJustifyMode = function (v) {
	...
	window.SetTabletState = function (v, ctx, tv)
	{
		var delay;
