...
@Component({
  selector: 'crm-label',
  templateUrl: './CrmLabel.html',
  styleUrls: ['./CrmLabel.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => CrmLabel),
      multi: true
    }
  ]
})
export class CrmLabel extends CrmFormInput implements OnInit, ControlValueAccessor {
