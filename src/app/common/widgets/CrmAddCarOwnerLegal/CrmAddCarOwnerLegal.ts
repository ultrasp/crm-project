...
@Component({
  selector: 'crm-add-car-owner-legal',
  templateUrl: './CrmAddCarOwnerLegal.html',
  styleUrls: ['./CrmAddCarOwnerLegal.css']
})
export class CrmAddCarOwnerLegal implements OnInit, OnDestroy {
  ...
  form: FormGroup = new FormGroup({
    stir: new FormControl('', [Validators.required]),
  ...
  setRefType = (request: Reference): void => {
    request.setTypeId(CrmRefType.COMPANY_TYPE);
    return;
  }
