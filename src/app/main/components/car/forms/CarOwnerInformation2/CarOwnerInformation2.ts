...
@Component({
  selector: 'car-owner-information-2',
  templateUrl: './CarOwnerInformation2.html',
  styleUrls: ['./CarOwnerInformation2.css']
})
export class CarOwnerInformation2 implements OnInit {
