...
import {Country} from "../../../../../_shared/request/crm/Country";


@Component({
  selector: 'app-driver-birth-place',
  templateUrl: './driver-birthplace.component.html',
  styleUrls: ['./driver-birthplace.component.css'],
})
export class DriverBirthplaceComponent implements OnInit {
